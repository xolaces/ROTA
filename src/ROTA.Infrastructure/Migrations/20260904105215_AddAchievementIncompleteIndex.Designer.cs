...
namespace ROTA.Infrastructure.Migrations
{
    ...
    [Migration("20260904105215_AddAchievementIncompleteIndex")]
    partial class AddAchievementIncompleteIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ROTA.Domain.Entities.MarketListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<long>("SaleFeePaid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L)
                        .HasColumnName("sale_fee_paid");
                    ...
                    b.HasIndex("BuyerId")
                        .HasDatabaseName("ix_market_listings_buyer_id");
                    ...
                    b.HasIndex("SellerId")
                        .HasDatabaseName("ix_market_listings_seller_id");

                    b.HasIndex("Kind", "DefinitionId", "UnitPrice")
                        .HasDatabaseName("ix_market_listings_board")
                        .HasFilter("status = 0 AND is_deleted = false");

                    b.ToTable("market_listings", (string)null);
                });

            modelBuilder.Entity("ROTA.Domain.Entities.MarketTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<long>("ListingFee")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L)
                        .HasColumnName("listing_fee");
                    ...
                    b.Property<long>("SellerProceeds")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ROTA.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ROTA.Domain.Entities.PlayerGauntletBattalion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("GeneralsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("[]")
                    ...
                    b.ToTable("player_gauntlet_battalions", (string)null);
                });
            ...
            modelBuilder.Entity("ROTA.Domain.Entities.PunishmentLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("punishment_log", (string)null);
                });
