...
public interface IGauntletService
{
    ...
    /// <summary>
    /// the kind-aware prize preview table, hydrated with trophy/magic display names. Kind
    ...
    /// <summary>
    /// the caller's result in the most recently SETTLED event (any kind): final league rank,
